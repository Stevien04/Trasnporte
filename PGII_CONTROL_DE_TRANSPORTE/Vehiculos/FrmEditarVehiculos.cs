...
namespace PGII_CONTROL_DE_TRANSPORTE
{
    ...
    {
        public FrmEditarVehiculos(int idVehiculo,string codigo,int idConductor, string placa, string tipo, string marca, string modelo, string color, DateTime fechaRegistro, string nAsientos, string estado)
        {
            InitializeComponent();

            txtid.Text = idVehiculo.ToString();
            ...
            txtcolor.Text = color;
            txtFecha.Text = fechaRegistro.ToString();
            txtasientos.Text = nAsientos;
